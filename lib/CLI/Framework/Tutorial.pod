...
documentation in L<CLI::Framework::Application> and L<CLI::Framework::Command>,
...
L<CLI::Framework::Application> enumerates many advantages to using CLIF
...
A "P.O.S." is a "Plain Old Script."  This section shows you how to reform that
...
totally optional) that inherits from L<CLI::Framework::Application> and
...
in the L<CLI::Framework::Applicaton> documentation for the long list):
...
in the L<CLI::Framework::Application> documentation.
...
at the least, to understand how CLIF differentiates between options/args that
are meant for the application itself and those options/args that are meant for
individual commands.
...
(notice that the final arguments apply to the final subcommand.  In this form, the
...
it is for business logic -- little additional CLIF-specific code is needed.

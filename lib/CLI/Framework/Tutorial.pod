...
advantages (see
L<DESIGN GOALS AND FEATURES|CLI::Framework/DESIGN GOALS AND FEATURES>
in the L<CLI::Framework> documentation for the long list):
...
in the L<CLI::Framework> documentation.
...
You may wish to provide an application option (--interactive) to start
...
For more details, see (L<http://cpanforum.com/posts/12426>).
